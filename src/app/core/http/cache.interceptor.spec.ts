...
describe('CacheInterceptor', () => {
  let interceptorOptions: any | null = {};
  let httpCacheService: HttpCacheService;
  let http: HttpClient;
  let httpMock: HttpTestingController;

  const createInterceptor = (_httpCacheService: HttpCacheService) => new CacheInterceptor(_httpCacheService).configure(interceptorOptions);
